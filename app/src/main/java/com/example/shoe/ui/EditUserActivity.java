...
//        _getUserInfo();
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(fullname.trim().equalsIgnoreCase("")){
                    ...
                    _update(user.getId(), fullname, username, email, phone, dateOfBirth, imageBase64);
                }
    ...
    private void _update(Integer id, String fullname, String username, String email, String phone, String dateOfBirth, String avatar){
        Call<ApiResponse<User>> call = ApiClient.getInstance().updateUser(id,fullname, username, dateOfBirth, phone, avatar);
        call.enqueue(new Callback<ApiResponse<User>>() {
            ...
            public void onResponse(Call<ApiResponse<User>> call, Response<ApiResponse<User>> response) {
                if(response.isSuccessful()){
                    ...
                    UserManagementActivity.fetchUsers();
                }
                else {
//                    _alert("Cập nhật thất bại");
                    AppUtils.alertError(EditUserActivity.this, response);
